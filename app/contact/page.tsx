    ...
    <main className="flex-1 w-full max-w-[820px] mx-auto p-6 md:p-10 mb-20 mt-4 md:mt-8 bg-surface rounded-3xl shadow-sm border border-border">
      <article className="prose prose-lg max-w-none">
        <header className="mb-10 border-b border-border pb-8">
          <p className="mb-3 text-sm font-semibold text-action">Contact</p>
        ...
        <section className="space-y-8 text-text/80">
          ...
          <div>
            <h2 className="text-xl font-semibold text-text">문의 시 포함하면 좋은 정보</h2>
          ...
          <div className="rounded-3xl border border-border bg-canvas/70 p-6">
            <h2 className="mt-0 text-xl font-semibold text-text">대체 연락처와 답변 기준</h2>
            <p>
            ...
            <ul className="list-disc pl-5 space-y-2">
              <li>운영자: Eunji</li>
              <li>이메일: <a href="mailto:dmswl6310@gmail.com" className="font-semibold text-action hover:underline">dmswl6310@gmail.com</a></li>
