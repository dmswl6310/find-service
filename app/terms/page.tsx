    ...
    <main className="flex-1 w-full max-w-[800px] mx-auto p-6 md:p-10 mb-20 mt-4 md:mt-8 bg-surface rounded-3xl shadow-sm border border-border">
      <article className="prose prose-lg max-w-none">
        ...
        <section className="space-y-8 text-text/80">
          <div>
            <h2 className="text-xl font-semibold text-text mb-3">제1조 (목적)</h2>
            <p>
          ...
          <div>
            <h2 className="text-xl font-semibold text-text mb-3">제2조 (약관의 게시와 개정)</h2>
          ...
          <div>
            <h2 className="text-xl font-semibold text-text mb-3">제3조 (서비스의 제공)</h2>
            <p>
            ...
            <p className="mt-4 text-sm text-text/60 italic">
              * 제공되는 경로나 소요 시간 데이터는 외부 API(ODsay, 카카오 등)에 의존하므로, 실제 상황과 다를 수 있으며 웹사이트는 이에 대한 법적 책임을 지지 않습니다.
            </p>
          </div>

          <div>
            <h2 className="text-xl font-semibold text-text mb-3">제4조 (이용자의 의무 및 금지 행위)</h2>
            <ul className="list-decimal pl-5 space-y-2">
          ...
          <div>
            <h2 className="text-xl font-semibold text-text mb-3">제5조 (데이터와 결과의 한계)</h2>
            <p>
          ...
          <div>
            <h2 className="text-xl font-semibold text-text mb-3">제6조 (면책 조항)</h2>
            <ul className="list-decimal pl-5 space-y-2">
          ...
          <div>
            <h2 className="text-xl font-semibold text-text mb-3">제7조 (문의 및 운영자 연락처)</h2>
            <p>
          ...
          <div>
            <h2 className="text-xl font-semibold text-text mb-3">제8조 (기타)</h2>
            <p>
