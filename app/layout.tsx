...
export const metadata: Metadata = {
  ...
  description: "여러 출발지와 목적지의 대중교통 소요시간을 한눈에 비교해보세요. 다중 출발지 최단거리, 대중교통 중간지점 찾기 서비스.",
        ...
        <footer className="w-full py-10 mt-auto border-t border-border bg-surface/50">
          <div className="max-w-[1400px] mx-auto px-4 sm:px-6 md:px-8">
            <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-foreground/60">
              <p>
                © {new Date().getFullYear()} 모두비교. All rights reserved.
              </p>
              <div className="flex items-center gap-4 flex-wrap justify-center">
                ...
                <span className="text-border">|</span>
                <Link href="/tips" className="hover:text-primary transition-colors font-medium">
                  애드센스 가이드
                </Link>
              </div>
            </div>
