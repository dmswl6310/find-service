    ...
    <main className="flex-1 w-full max-w-[800px] mx-auto p-6 md:p-10 mb-20 mt-4 md:mt-8 bg-surface rounded-3xl shadow-sm border border-border">
      <article className="prose prose-slate prose-lg max-w-none">
        ...
        <section className="space-y-8 text-foreground/80">
          ...
          <div>
            <h2 className="text-xl font-bold text-foreground mb-3">2. 처리하는 정보 항목</h2>
            <p>
          ...
          <div>
            <h2 className="text-xl font-bold text-foreground mb-3">3. 구글 애드센스, 분석 도구 및 쿠키 사용</h2>
            <p>
            ...
            <ul className="list-disc pl-5 mt-2 space-y-1">
              ...
              <li>Google이 파트너 사이트에서 데이터를 사용하는 방식은 <a href="https://policies.google.com/technologies/partner-sites" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">Google 안내 페이지</a>에서 확인할 수 있습니다.</li>
              <li>사용자는 <a href="https://myadcenter.google.com/" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">광고 설정</a>에서 맞춤 광고를 관리할 수 있습니다.</li>
            </ul>
          </div>

          <div>
            <h2 className="text-xl font-bold text-foreground mb-3">4. 개인정보의 처리 및 보유 기간</h2>
            <p>
          ...
          <div>
            <h2 className="text-xl font-bold text-foreground mb-3">5. 이용자 및 법정대리인의 권리와 그 행사방법</h2>
            <p>
          ...
          <div>
            <h2 className="text-xl font-bold text-foreground mb-3">6. 제3자 제공 및 처리 위탁</h2>
            <p>
          ...
          <div>
            <h2 className="text-xl font-bold text-foreground mb-3">7. 개인정보 보호 문의</h2>
            <p>
          ...
          <div>
            <h2 className="text-xl font-bold text-foreground mb-3">8. 기타</h2>
            <p>
