    ...
    <main className="flex-1 w-full max-w-[900px] mx-auto p-6 md:p-10 mb-20 mt-4 md:mt-8 bg-surface rounded-3xl shadow-sm border border-border">
      ...
      <article className="prose prose-slate prose-lg max-w-none">
        ...
        <section className="space-y-8 text-foreground/80">
          <div>
            <h2 className="text-2xl font-bold text-foreground">제공하는 기능</h2>
          ...
          <div>
            <h2 className="text-2xl font-bold text-foreground">데이터 출처</h2>
            <p>
        ...
        <div className="mt-10 flex flex-col gap-3 sm:flex-row">
          <Link href="/privacy" className="inline-flex items-center justify-center rounded-xl border border-border bg-background px-6 py-3 text-sm font-bold text-foreground hover:text-primary transition-colors">
            개인정보처리방침
          </Link>
          <Link href="/contact" className="inline-flex items-center justify-center rounded-xl bg-primary px-6 py-3 text-sm font-bold text-white hover:bg-primary-hover transition-colors">
            문의하기
          </Link>
        </div>
      </article>
